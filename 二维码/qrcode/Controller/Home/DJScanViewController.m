...
- (void)setUpNavigation
{
    ...
    [button1 setImage:[UIImage imageNamed:@"sina_back"] forState:UIControlStateNormal];
    [button1 setImage:[UIImage imageNamed:@"sina_back"] forState:UIControlStateHighlighted];
