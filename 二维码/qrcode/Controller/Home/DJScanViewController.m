...
@interface DJScanViewController ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
//    }else {
//        UIAlertView * alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"scan result", nil) message:NSLocalizedString(@"Unable to identify QRCode in a graph", nil) delegate:nil cancelButtonTitle:NSLocalizedString(@"confirm", nil) otherButtonTitles:nil, nil];
//        [alertView show];
//    }
//}
@end
