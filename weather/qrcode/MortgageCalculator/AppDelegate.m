...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [manager GET:@"https://free-api.heweather.com/s6/weather/forecast" parameters:@{@"location":@"北京", @"key":@"4b7af68acb6543199364134d981ced8c"} success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
    ...
    [manager GET:@"https://api.heweather.com/s6/weather/grid-hourly" parameters:@{@"location":@"北京", @"key":@"4b7af68acb6543199364134d981ced8c"} success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
